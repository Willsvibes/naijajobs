...
export const JobsPanel = ({ jobs, search, actionId, onSearchChange, onDelete }: JobsPanelProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-slate-500 text-xs">{jobs.length} services</p>
      ...
      <div className="space-y-3">
        {jobs.map((job) => (
          <div
            ...
            className="flex items-center gap-4 p-4 rounded-2xl border border-slate-800 bg-slate-900/60 hover:border-slate-700 transition-all cursor-pointer"
          >
